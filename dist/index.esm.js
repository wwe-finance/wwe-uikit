...
var Icon$w = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React.createElement("image", { width: 128, height: 128, href: "/images/egg/9.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 554 62" }, props),
        React.createElement("image", { width: "554", height: "62", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Icon$X = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 128 105" }, props),
        React.createElement("image", { width: "128", height: "105", href: "/images/menu/meme-icon.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, { alignItems: "center" },
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$Q, { width: "24px", color: theme.nav.textColor })) : (React.createElement(Icon$P, { width: "24px", color: theme.nav.textColor }))),
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SettingsEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
                ...
                React.createElement(Text, { color: theme.nav.textColor, bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
            friendPriceUsd ? (React.createElement(PriceLink, { href: friendPriceLink, target: "_blank" },
                React.createElement(Icon$o, { width: "24px", mr: "8px" }),
                React.createElement(Text, { color: theme.nav.textColor, bold: true }, "$" + friendPriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }))),
...
var RugDocLock = function (_a) {
    var props = __rest(_a, []);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 376 127" }, props),
        React.createElement("image", { width: "376", height: "127", href: '/images/egg/RugDocLock.png' })));
};

var StyledLock = styled.div(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n  margin-bottom: 5px;\n  text-align: center;\n\n  svg {\n    width: 100%;\n  }\n"], ["\n  margin-bottom: 5px;\n  text-align: center;\n\n  svg {\n    width: 100%;\n  }\n"])));
var RugDocLockButton = function (_a) {
    var auditLink = _a.auditLink;
    return (React.createElement(StyledLock, null,
        React.createElement("a", { href: auditLink, "aria-label": "LockLink", target: "_blank" },
            React.createElement(RugDocLock, null))));
};
var templateObject_1$E;
...
var JagoSaferAudit = function (_a) {
    var props = __rest(_a, []);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 370 121" }, props),
        React.createElement("image", { width: "370", height: "121", href: '/images/egg/greenflag.svg' })));
};

var StyledAudit$1 = styled.div(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  margin-bottom: 5px;\n  text-align: center;\n\n  svg {\n    width: 100%;\n  }\n"], ["\n  margin-bottom: 5px;\n  text-align: center;\n\n  svg {\n    width: 100%;\n  }\n"])));
var JagoSaferAuditButton = function (_a) {
    var auditLink = _a.auditLink;
    return (React.createElement(StyledAudit$1, null,
        React.createElement("a", { href: auditLink, "aria-label": "AuditLink", target: "_blank" },
            React.createElement(JagoSaferAudit, null))));
};
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        ...
        rugDocLink && React.createElement(RugDocAuditButton, { auditLink: rugDocLink }),
        rugDocLink && React.createElement(RugDocLockButton, { auditLink: rugDocLink }),
        jagoSaferLink && React.createElement(JagoSaferAuditButton, { auditLink: jagoSaferLink }),
